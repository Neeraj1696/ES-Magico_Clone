...
function About() {
  return (
    <div className="about bg-black text-white pl-52 pr-20 w-full ">
      <div className="about_heading">
        <div className="container     ">
          <h1 className="title text-5xl font-bold pt-28 ml-20 ">About</h1>
          <div className="line border-4 w-36 ml-20 mt-6"></div>
          <h3 className="title text-2xl font-bold mt-9 pl-20">Who We are</h3>
          <p className="font-weight text-xl  mt-9 pl-20 ">
          ...
          <p className="font-weight text-xl mt-9 pl-20 pb-10 ">
